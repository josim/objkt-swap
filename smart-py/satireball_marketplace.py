...
class Marketplace(sp.Contract):
    ...
    SWAP_TOKEN_TYPE = sp.TRecord(
        ...
        # The price of each edition in token amount
        token_per_objkt=sp.TNat,
        # The artists royalties in (1000 is 100%)
        royalties=sp.TNat,
        # The address that will receive the royalties
        creator=sp.TAddress).layout(
            ("issuer", ("fa2", ("objkt_id", ("objkt_amount", ("xtz_per_objkt", ("token_per_objkt", ("royalties", "creator")))))))
    ...
    @sp.entry_point
    def swap_for_token(self, params):
